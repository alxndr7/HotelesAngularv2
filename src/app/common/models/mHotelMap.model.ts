import {TPisosHotel} from './tPisosHotel.model';

export class MHotelMap {
    ...
    private _pisosHotel: TPisosHotel[];
    ...
    get pisosHotel(): TPisosHotel[] {
        return this._pisosHotel;
    }

    set pisosHotel(value: TPisosHotel[]) {
        this._pisosHotel = value;
    }
}
